...
## Vérifications
Les tests d'intégration doivent vérifier que la composition racine possède un Orchestrator, que la soumission autonome passe par celui-ci et que le fabric utilisé par le pipeline est celui du système.