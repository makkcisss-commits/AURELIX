...
def _start_unified_system() -> None:
    global _system_thread
    if _system is None or (_system_thread is not None and _system_thread.is_alive()):
        return
...
async def lifespan(app: FastAPI):
    ...
    _start_unified_system()
    try:
        yield
    finally:
        _stop_unified_system()
