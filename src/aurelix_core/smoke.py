...
class SmokeModelProvider(ModelProvider):
    ...
    def structured_output(self, prompt: str, schema: dict) -> dict:
        return {"title": "Evidence-backed automation opportunity", "problem": "A bounded workflow remains manual.", "proposed_solution": "Automate the bounded workflow.", "expected_value": "Reduce cycle time.", "estimated_cost": 100.0, "risk": 2, "confidence": 0.8}
