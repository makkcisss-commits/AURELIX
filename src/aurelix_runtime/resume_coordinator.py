...
class DurableResumeCoordinator:
    ...
    def resume(self, mission: Any) -> str:
        ...
        with self.store.lock, self.store.db:
            ...
            # The completed learning phase is a lifecycle checkpoint, not a
            # new execution. Remove its terminal result and put the exact same
            # job back into the durable queue with a clean attempt counter.
