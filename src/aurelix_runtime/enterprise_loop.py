...
class EnterpriseLoop:
    ...
    def __init__(self, *, runtime_store, knowledge_repository, research, academy, knowledge_engine, innovation, experiment, evaluation, opportunity, business,
        ...
        self.opportunity = opportunity; self.business = business; self.experiment_submitter = experiment_submitter
    ...
    def continue_after_experiment(self, experiment_id: str) -> dict[str, Any]:
        """Resume a durable enterprise cycle after real experiment completion, once."""
        ...
        final_result = {"status": status, "experiment_id": experiment_id, "objective": objective, "evaluation": evaluation, "opportunity": opportunity, "business": business}
