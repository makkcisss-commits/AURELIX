...
class AcademyEngine:
    ...
    def run(self, research: Dict[str, Any], store: EngineStore) -> Dict[str, Any]:
        ...
        return {"lessons": lessons, "evidence": evidence, "gaps": [] if lessons else [research.get("objective", "unknown")]}
...
class KnowledgeEngine:
    ...
    def run(self, academy: Dict[str, Any], store: EngineStore) -> Dict[str, Any]:
        ...
        return {"knowledge_id": item.id, "lessons": academy.get("lessons", []), "evidence": evidence, "validated": verified}
...
class InnovationEngine:
    ...
    def run(self, knowledge: Dict[str, Any], store: EngineStore) -> Dict[str, Any]:
        ...
        if self.model_gateway:
            ...
            proposal = {"id": str(uuid4()), "basis": knowledge.get("knowledge_id"), "evidence_count": len(evidence), **result}
        else:
...
class OpportunityEngine:
    ...
    def run(self, evaluation: Dict[str, Any], store: EngineStore) -> Dict[str, Any]:
        opportunity = Opportunity(str(uuid4()), "Opportunity candidate", "Generated from evaluated evidence; requires validation.")
...
class BusinessEngine:
    ...
    def run(self, opportunity: Dict[str, Any], approved: bool = False) -> Dict[str, Any]:
        if self.require_approval and not approved: return {"status":"awaiting_approval", "opportunity_id":opportunity.get("opportunity_id")}
