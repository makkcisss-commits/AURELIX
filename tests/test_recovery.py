...
def test_recovery_requeues_checkpointed_job_without_fabricating_completion(tmp_path: Path) -> None:
    ...
    store.record_result(job.job_id, {"ok": True, "value": 42}, worker_id=claimed.worker_id, lease_token=claimed.lease_token)
