...
def test_engine_factory_uses_durable_audit_sink_without_second_store(tmp_path, monkeypatch):
    db_path = tmp_path / "runtime.db"
    monkeypatch.setenv("AURELIX_AUDIT_DB", str(tmp_path / "must-not-create.db"))
